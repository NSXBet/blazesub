...
type Registry interface {
	RegisterSubscription(filter string, id int, subscription *Subscription) error
	RemoveSubscription(id int)
	ExecuteSubscriptions(topic string, callback SubscriptionCallback) error
}
...
func (r *RegistryImpl) matchTopic(filter, topic string) bool {
...
func (r *RegistryImpl) RegisterSubscription(filter string, id int, subscription *Subscription) error {
...
func (r *RegistryImpl) RemoveSubscription(id int) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *RegistryImpl) rebuildCache() {
...
func (r *RegistryImpl) ExecuteSubscriptions(topic string, callback SubscriptionCallback) error {
	// Validate topic
